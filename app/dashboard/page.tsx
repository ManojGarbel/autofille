  ...
  return (
    <main className="max-w-5xl mx-auto p-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        {!(process.env.NEXT_PUBLIC_BASE_URL && /^https?:\/\//.test(process.env.NEXT_PUBLIC_BASE_URL)) && (
          <div className="card p-5 md:col-span-3 border-amber-300">
            <h2 className="font-semibold mb-2 text-amber-700">Important: Set your site URL</h2>
            <p className="text-sm text-amber-700">To use the bookmarklet across other sites (desktop and mobile), set <span className="font-mono">NEXT_PUBLIC_BASE_URL</span> to your deployed URL in Vercel Project Settings. Without it, the bookmarklet only works on pages under this site.</p>
          </div>
        )}
